...
function Single_post_help_center() {
  return (
    <div>
          ...
          <div class="single_post">
            <ul>
              <li>
                ...
                airport and these are outlined on our website. Our booster seats
                are suitable for children weighing 15-36 kilos (approx. 4-12
                years) while baby seats are suitable for toddlers weighing 9-18
                kg (approx. 9 months to 4 years).
              </li>
              <li>
